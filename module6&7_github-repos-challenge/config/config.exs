...
config :github_repos, GithubReposWeb.Endpoint,
  ...
  live_view: [signing_salt: "fjt/19kO"]

config :github_repos, GithubReposWeb.Auth.Guardian,
  issuer: "github_repos",
  secret_key: "015P6zQAJO031yPSP/fd8bCoS5okekxx3I11Uydhxg4MWC1fmrTZIHQxwbUsRm3d"
...
config :github_repos, GithubRepos.Mailer, adapter: Swoosh.Adapters.Local
